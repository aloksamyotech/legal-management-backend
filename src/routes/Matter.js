...
const router = Router();
router.post("/addMatter", jwtMiddleware, asyncHandler(matterController.MatterAdd));
router.get("/getMatter", asyncHandler(matterController.MatterFetch));
router.get("/getAllMatter", jwtMiddleware, asyncHandler(matterController.GetAllmatter));
